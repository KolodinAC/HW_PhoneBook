...
import json
pb = {}
help = ['/stop - завершить работу телефонной книги', '/add - добавить контакт', '/showall - показать все контакты', '/edit - добавить номер к существующему контакту',
...
while True:
    ...
    if cmd == '/add':
        ...
        print('Телефонная книга завершила работу. Спасибо, приходите еще!')
        save()
        break
    else:
